...
interface TimeTrackingManagePageProps {
  params: {
    id: number;
  };
}

const TimeTrackingManagePage: React.FC<TimeTrackingManagePageProps> = async ({ params }) => {
  ...
  // }
  // return <TimeTrackingManageView workspace={workspace.data} />
}
...
export default TimeTrackingManagePage