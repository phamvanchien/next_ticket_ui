...
export const update = async (workspaceId: number, projectId: number, taskId: number, commentId: number, payload: {content?: string, deleted?: number}): Promise<BaseResponseType> => {
  return request({
